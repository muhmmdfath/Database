...
INSERT INTO `detail_pemesanan` (`ID_Detail`, `ID_Pemesanan`, `ID_Produk`, `Jumlah`) VALUES
(1, 10248, 11, 12),
(2, 10248, 42, 10),
(3, 10248, 72, 5),
(4, 10249, 14, 9),
...
INSERT INTO `pegawai` (`ID_Pegawai`, `Nama_Belakang`, `Nama_Depan`, `Tanggal_Lahir`, `Foto`, `Catatan`) VALUES
...
INSERT INTO `pelanggan` (`ID_Pelanggan`, `Nama_Pelanggan`, `Nama_Kontak`, `Alamat`, `Kota`, `Kode_Pos`, `Negara`) VALUES
...
INSERT INTO `pemesanan` (`ID_pemesanan`, `ID_Pelanggan`, `ID_Pegawai`, `Tanggal_Pemesanan`, `ShipperID`) VALUES
...
INSERT INTO `produk` (`ID_Produk`, `Nama_Produk`, `SupplierID`, `CategoryID`, `Unit`, `Harga`) VALUES
...
CREATE TABLE `shipper` (
  ...
  `Nama_Shipper` varchar(255) DEFAULT NULL,
...
INSERT INTO `shipper` (`ShipperID`, `Nama_Shipper`, `No_Telepon`) VALUES
...
CREATE TABLE `supplier` (
  ...
  `Nama _Suppiler` varchar(255) DEFAULT NULL,
  `Nama_Kontak` varchar(255) DEFAULT NULL,
  `Alamat` varchar(255) DEFAULT NULL,
  `Kota` varchar(255) DEFAULT NULL,
  `Kode Pos` varchar(255) DEFAULT NULL,
  `Negara` varchar(255) DEFAULT NULL,
  `No_Telepon` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `supplier` (`SupplierID`, `Nama _Suppiler`, `Nama_Kontak`, `Alamat`, `Kota`, `Kode Pos`, `Negara`, `No_Telepon`) VALUES
...
ALTER TABLE `detail_pemesanan`
  ...
  ADD KEY `OrderID` (`ID_Pemesanan`),
  ADD KEY `ProductID` (`ID_Produk`);
...
ALTER TABLE `pemesanan`
  ...
  ADD KEY `CustomerID` (`ID_Pelanggan`),
  ADD KEY `EmployeeID` (`ID_Pegawai`),
...
--
ALTER TABLE `detail_pemesanan`
  MODIFY `ID_Detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=519;
...
--
ALTER TABLE `pelanggan`
  MODIFY `ID_Pelanggan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT for table `pemesanan`
--
ALTER TABLE `pemesanan`
  MODIFY `ID_pemesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10444;
...
ALTER TABLE `pemesanan`
  ...
  ADD CONSTRAINT `pemesanan_ibfk_2` FOREIGN KEY (`ID_Pegawai`) REFERENCES `pegawai` (`ID_Pegawai`),
  ADD CONSTRAINT `pemesanan_ibfk_3` FOREIGN KEY (`ShipperID`) REFERENCES `shipper` (`ShipperID`);

--
-- Constraints for table `produk`
--
ALTER TABLE `produk`
  ADD CONSTRAINT `produk_ibfk_1` FOREIGN KEY (`CategoryID`) REFERENCES `kategori` (`ID_Kategori`),
